...
3. 右键 → **Start** 启动节点
4. 双击节点打开 Console，看到欢迎信息后按回车连接 CLI
...
```bash
# 方式 1：进入容器查看日志文件
docker exec <container_id> tail -f /opt/netnexus/log/netnexus.log
