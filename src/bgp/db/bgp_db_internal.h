...
/** instance 表 PK：vrf_id + afi + safi */
void bgp_db_instance_pk(db_filter_builder_t *pk, uint32_t vrf_id, bgp_afi_t afi, bgp_safi_t safi);

/** qp_route 表 PK：vrf_id + afi + safi + start_dqpn + route_count + prefix_addr + mask_len + bid */
