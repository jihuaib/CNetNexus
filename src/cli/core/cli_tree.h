...
typedef enum
{
    CLI_VIEW_USER,   // Default user view
    CLI_VIEW_CONFIG, // Configuration view
    CLI_VIEW_BGP,    // BGP configuration view
    CLI_VIEW_BMP,    // BMP configuration view
    CLI_VIEW_RPKI,   // RPKI configuration view
    CLI_VIEW_ALL     // Available in all views (global commands)
} cli_view_t;
