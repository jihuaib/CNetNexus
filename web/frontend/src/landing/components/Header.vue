        ...
        <div class="container header-container">
            ...
            <div class="github-info">
                <a href="https://github.com/jihuaib/NetNexus" target="_blank" class="github-link">
                    ...
                    <span class="repo-name">jihuaib/NetNexus</span>
                </a>
                <div class="stats">
                    <a href="https://github.com/jihuaib/NetNexus/stargazers" target="_blank">
                        <img
                            src="https://img.shields.io/github/stars/jihuaib/NetNexus?style=flat-square&color=1890ff&label=Stars"
                            alt="GitHub stars"
                        />
                    </a>
...
<style scoped>
    .header {
        ...
        width: 100%;
        padding: 1rem 0;
        background: rgba(0, 21, 41, 0.85); /* Matches new blue bg */
