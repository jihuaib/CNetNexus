...
echo "Next steps:"
echo "1. Test locally:"
echo "   docker run -d --rm --name netnexus-test ${IMAGE_NAME}:latest"
echo "   docker exec -it -e NN_CONSOLE_SOCK=/opt/netnexus/run/console.sock netnexus-test /opt/netnexus/bin/netnexus-console"
