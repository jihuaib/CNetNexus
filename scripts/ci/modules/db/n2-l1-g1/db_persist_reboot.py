...
CONFIG_COMMANDS = [
    ...
    "exit",
    f"route static ipv4 {ROUTE_V4_PREFIX} {ROUTE_V4_MASK} {ROUTE_V4_NH} metric {ROUTE_V4_METRIC}",
    f"route static ipv6 {ROUTE_V6_PREFIX} {ROUTE_V6_MASK} interface {GE_IF} metric {ROUTE_V6_METRIC}",
    f"bgp {BGP_AS_R1}",
...
DELETE_STEPS: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "commands": [
            "config",
            f"no route static ipv6 {ROUTE_V6_PREFIX} {ROUTE_V6_MASK} interface {GE_IF}",
            "end",
        ],
        "not_contains": [f"route static ipv6 {ROUTE_V6_PREFIX} {ROUTE_V6_MASK} interface {GE_IF} metric {ROUTE_V6_METRIC}"],
    },
    {
        "label": "Route IPv4 static",
        "commands": [
            "config",
            f"no route static ipv4 {ROUTE_V4_PREFIX} {ROUTE_V4_MASK} {ROUTE_V4_NH}",
            "end",
        ],
        "not_contains": [f"route static ipv4 {ROUTE_V4_PREFIX} {ROUTE_V4_MASK} {ROUTE_V4_NH} metric {ROUTE_V4_METRIC}"],
    },
    {
